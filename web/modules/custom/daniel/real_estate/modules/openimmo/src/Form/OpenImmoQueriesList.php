...
class OpenImmoQueriesList extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['queries'] = [
      ...
      '#empty' => $this->t('No queries available. <a href=":link">Add a query</a>', [':link' => $this->url('entity.real_estate_openimmo.add_query_form', ['real_estate_openimmo' => $this->entity->id()])]),
    ...
    foreach ($this->entity->getQueries() as $query) {
      ...
      $links['edit'] = [
        'title' => $this->t('Edit'),
        'url' => Url::fromRoute('entity.real_estate_openimmo.edit_query_form', [
          'real_estate_openimmo' => $this->entity->id(),
          'source_query' => $query->id(),
        ]),
      ];
      $links['delete'] = [
        'title' => $this->t('Delete'),
        'url' => Url::fromRoute('entity.real_estate_openimmo.delete_query_form', [
          'real_estate_openimmo' => $this->entity->id(),
          'source_query' => $query->id(),
        ]),
      ];
  ...
  public function save(array $form, FormStateInterface $form_state) {
    foreach ($this->entity->getQueries() as $query) {
      ...
      $weight = 1;
      /** @var \Drupal\real_estate_openimmo\OpenImmoInterface $this->entity */
