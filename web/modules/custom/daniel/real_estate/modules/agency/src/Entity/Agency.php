 ...
 *   },
 *   links = {
 *     "canonical" = "/agency/real_estate_agency/{real_estate_agency}",
 *     "add-page" = "/agency/real_estate_agency/add",
 *     "add-form" = "/agency/real_estate_agency/add/{real_estate_agency_type}",
 *     "edit-form" = "/agency/real_estate_agency/{real_estate_agency}/edit",
 *     "delete-form" = "/agency/real_estate_agency/{real_estate_agency}/delete",
 *     "collection" = "/agency/real_estate_agency",
 *   },
...
class Agency extends ContentEntityBase implements AgencyInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['status']->setDescription(t('A boolean indicating whether the Agency is published.'))
      ->setDisplayOptions('form', [
